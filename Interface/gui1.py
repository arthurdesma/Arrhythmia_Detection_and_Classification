...
def relative_to_assets(path: str) -> Path:
    ...
    ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\paulg\Documents\GitHub\Tkinter-Designer\build\assets\frame1")
...
def start_gui(file_path_arg):  # Renommez le paramètre pour éviter le conflit avec la variable globale
    ...
    update_button.place(x=190.0, y=243.0)  # Placez le bouton à l'endroit souhaité sur la fenêtre
